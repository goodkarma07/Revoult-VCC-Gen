...
class RevGen:
    ...
    def get_card_details(self):
        ...
        while Resend:
            ...
            self.sms_code = getsms()
            if self.sms_code == "Code not received.":
                self.send_sms()  
            elif self.sms_code == "API error.":
                print('SMS Activate API error')
                return 
            else:
                Resend = False
        
        print(f'Received SMS code: {self.sms_code}')
